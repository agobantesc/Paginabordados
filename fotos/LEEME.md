# Carpeta de fotos de Alma Bordado

Aquí van el logo y las fotos de los bordados. El sitio ya está preparado para
mostrarlas apenas existan, usando exactamente estos nombres de archivo:

Tienda con 3 bordados por ahora (mandala, girasoles y hongos):
...
> Los bordados Maggie, Pantera Rosa, Calavera mexicana y Mar y ballenas quedaron
> en pausa (comentados en `app.js`); se reactivan moviéndolos al arreglo `PRODUCTOS`.
